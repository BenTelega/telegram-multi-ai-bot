...
Multi-AI Telegram Bot — хаб ИИ-ассистентов в Telegram с выбором модели через OpenRouter API. Поддерживает Llama, DeepSeek, Claude, Grok и Qwen. Каждая модель имеет собственное приветствие и позиционирование.
